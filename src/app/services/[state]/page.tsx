...
import { getBusinessesByState, getAllStates } from "@/lib/utils/businessData";
...
export async function generateMetadata({
  ...
  const businesses = getBusinessesByState(stateCode);
  ...
  return {
    title: `Toilet Services in ${stateName} | Toilets.org`,
    description: `Find the best plumbers and bathroom specialists in ${stateName}. Connect with trusted professionals for installations, repairs, and maintenance.`,
  };
}
      ...
      <div className="container mx-auto px-4">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-4">
            Toilet Services in {stateName}
          </h1>
          <p className="text-lg text-gray-600">
            Find reliable plumbers and bathroom specialists in {stateName} for
...
// This function would generate all the state pages at build time
