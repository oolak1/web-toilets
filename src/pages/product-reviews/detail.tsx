  ...
  "1": {
    ...
    reviews: [
      ...
      },
      {
        ...
        content: "This toilet has amazing features - the heated seat, bidet, and night light are all fantastic. The only reason I'm giving 4 stars instead of 5 is the price point. It's definitely a luxury item, but if you can afford it, it's worth the investment for the comfort and features it provides.",
        helpful: 18,
        comments: 2,
      },
    ],
    ...
    reviews: [
      {
        ...
        content: "We installed this toilet during our bathroom renovation and have been very pleased with it. The dual flush feature works great and we've noticed a significant decrease in our water bill. The design is sleek and modern, and it's very easy to clean.",
        helpful: 15,
        comments: 1,
      },
    ],
