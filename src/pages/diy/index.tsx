...
import { Hammer, Clock, Wrench, ArrowRight, Check } from "lucide-react";
                  ...
                  {popularTutorials.map((tutorial) => (
                    ...
                    >
                      ...
                      <CardContent className="p-4">
                        ...
                        <Link
                          to={`/diy/${tutorial.category.toLowerCase()}/${tutorial.slug}`}
                        >
                ...
                <div className="flex flex-col lg:flex-row">
                  ...
                  <div className="lg:w-1/2 p-6 md:p-8">
                    ...
                    <p className="text-gray-600 mb-6">
                      Transform your outdated bathroom into a modern oasis with
                      this comprehensive DIY renovation guide. Learn how to
                      replace fixtures, update lighting, install new flooring,
                      and more.
                    </p>
                    <div className="mb-6">
                    ...
                    <Link to="/diy/upgrades/bathroom-renovation">
